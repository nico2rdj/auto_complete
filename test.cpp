...
if(dt.find("Jui") == false && d_ht.find("Jui") == false && d_bst.find("Jui") == false  )
    cout << "Pass" << endl;
if(dt.find("") == false  && d_ht.find("") == false && d_bst.find("") == false )
    cout << "Pass" << endl;
if(dt.find("cs") == false && d_ht.find("cs") == false && d_bst.find("cs") == false )
    cout << "Pass" << endl;
